...
(function () {
  ...
  function setMobileDetailEmpty() {
    ...
    if (!el) return;
    el.innerHTML =
      '<div class="tbw-mobile-detail-head">Selected Age</div>' +
      '<div class="tbw-mobile-detail-title">Tap a bar</div>' +
      '<div class="tbw-mobile-detail-meta">Touch a histogram column to inspect values.</div>';
  }
  ...
  function renderMobileDetail(ai) {
    ...
    el.innerHTML =
      '<div class="tbw-mobile-detail-head">Selected Age</div>' +
      '<div class="tbw-mobile-detail-title">Age ' + state.labels[index] + '</div>' +
      '<div class="tbw-mobile-detail-meta">Total: ' + total + '</div>' +
      (rows.length ? '<div class="tbw-mobile-detail-list">' + rows.join('') + '</div>' : '<div class="tbw-mobile-detail-empty">No data</div>');
  }
